...
urlpatterns = [
    ...
    path('fields/<int:field_pk>/time-slots/generate/', views.time_slot_bulk_generate_view, name='time_slot_bulk_generate'),
    path('fields/<int:field_pk>/time-slots/clear-expired/', views.time_slot_clear_expired_view, name='time_slot_clear_expired'),
    ...
    path('<int:pk>/cover-update/', views.stadium_cover_update_view, name='cover_update'),
    path('<int:pk>/delete-request/', views.stadium_delete_request_view, name='delete_request'),
    path('<int:pk>/delete-request/cancel/', views.stadium_delete_request_cancel_view, name='delete_request_cancel'),
